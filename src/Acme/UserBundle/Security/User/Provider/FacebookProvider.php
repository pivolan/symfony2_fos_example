...
class FacebookProvider implements UserProviderInterface
{
    ...
    public function loadUserByUsername($username)
    {
        ...
        try {
            $fbdata = $this->facebook->api('/me?fields=first_name,last_name,email,username,gender,picture,birthday');
        ...
        if (!empty($fbdata)) { //si on a des données recues de fb
            ...
            elseif (empty($user)) { //si on a pas de user trouvé correspondant déjà à un user fb dans notre base (l'id facebook=un username de notre base de données)
                ...
                /** @var $user \Acme\UserBundle\Document\User */
    ...
    /**
     * @param \Acme\UserBundle\Document\User|\Symfony\Component\Security\Core\User\UserInterface $user
     *
     * @throws \Symfony\Component\Security\Core\Exception\UnsupportedUserException
     * @return \Acme\UserBundle\Document\User|\Symfony\Component\Security\Core\User\UserInterface
     */
